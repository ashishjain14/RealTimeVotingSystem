...
if __name__ == "__main__":
    ...
    spark = (SparkSession.builder
             ...
             .config("spark.jars",
                     "/Users/I342413/Library/CloudStorage/OneDrive-SAPSE/work/ML/RealLiveProjects/RealTimeVotingSystem/lib/postgresql-42.7.7.jar")  # PostgreSQL driver
    ...
    votes_per_candidate_to_kafka = votes_per_candidate.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/Users/I342413/Library/CloudStorage/OneDrive-SAPSE/work/ML/RealLiveProjects/RealTimeVotingSystem/checkpoints/checkpoint1") \
        .outputMode("update") \
        .start()
    ...
    turnout_by_location_to_kafka = turnout_by_location.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/Users/I342413/Library/CloudStorage/OneDrive-SAPSE/work/ML/RealLiveProjects/RealTimeVotingSystem/checkpoints/checkpoint2") \
        .outputMode("update") \
        .start()
